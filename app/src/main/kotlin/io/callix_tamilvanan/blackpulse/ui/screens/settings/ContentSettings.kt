...
import io.callix_tamilvanan.blackpulse.constants.ContentCountryKey
import io.callix_tamilvanan.blackpulse.constants.ContentLanguageKey
import io.callix_tamilvanan.blackpulse.constants.CountryCodeToName
import io.callix_tamilvanan.blackpulse.constants.EnableBetterLyricsKey
import io.callix_tamilvanan.blackpulse.constants.EnableKugouKey
import io.callix_tamilvanan.blackpulse.constants.EnableLrcLibKey
import io.callix_tamilvanan.blackpulse.constants.EnablePaxsenixKey
import io.callix_tamilvanan.blackpulse.constants.EnableLyricsPlus
import io.callix_tamilvanan.blackpulse.constants.EnableZemerKey
...
import io.callix_tamilvanan.blackpulse.constants.HideYoutubeShortsKey
import io.callix_tamilvanan.blackpulse.constants.LanguageCodeToName
import io.callix_tamilvanan.blackpulse.constants.LyricsProviderOrderKey
import io.callix_tamilvanan.blackpulse.constants.ProxyEnabledKey
import io.callix_tamilvanan.blackpulse.constants.ProxyPasswordKey
import io.callix_tamilvanan.blackpulse.constants.ProxyTypeKey
import io.callix_tamilvanan.blackpulse.constants.ProxyUrlKey
import io.callix_tamilvanan.blackpulse.constants.ProxyUsernameKey
import io.callix_tamilvanan.blackpulse.constants.QuickPicks
import io.callix_tamilvanan.blackpulse.constants.QuickPicksKey
import io.callix_tamilvanan.blackpulse.constants.RandomizeHomeOrderKey
import io.callix_tamilvanan.blackpulse.constants.SYSTEM_DEFAULT
import io.callix_tamilvanan.blackpulse.constants.ShowArtistDescriptionKey
import io.callix_tamilvanan.blackpulse.constants.ShowMostStatsPlaylistsKey
import io.callix_tamilvanan.blackpulse.constants.ShowArtistSubscriberCountKey
import io.callix_tamilvanan.blackpulse.constants.ShowMonthlyListenersKey
import io.callix_tamilvanan.blackpulse.constants.ShowWrappedCardKey
import io.callix_tamilvanan.blackpulse.constants.TopSize
...
import io.callix_tamilvanan.blackpulse.ui.component.DraggableLyricsProviderItem
import io.callix_tamilvanan.blackpulse.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(io.callix_tamilvanan.blackpulse.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(io.callix_tamilvanan.blackpulse.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    io.callix_tamilvanan.blackpulse.db.entities.PlaylistEntity(
                        id = io.callix_tamilvanan.blackpulse.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    io.callix_tamilvanan.blackpulse.db.entities.PlaylistEntity(
                        id = io.callix_tamilvanan.blackpulse.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
