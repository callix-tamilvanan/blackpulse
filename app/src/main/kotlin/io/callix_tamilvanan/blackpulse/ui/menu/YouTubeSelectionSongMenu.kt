            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        io.callix_tamilvanan.blackpulse.db.entities.Song(
                            song =
                                io.callix_tamilvanan.blackpulse.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    io.callix_tamilvanan.blackpulse.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    io.callix_tamilvanan.blackpulse.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
