package io.callix_tamilvanan.blackpulse.recognition
...
import io.callix_tamilvanan.blackpulse.widget.MusicRecognizerWidgetReceiver
...
class RecognitionForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START_WIDGET_RECOGNITION = "io.callix_tamilvanan.blackpulse.widget.recognizer.START"
        const val ACTION_STOP_WIDGET_RECOGNITION = "io.callix_tamilvanan.blackpulse.widget.recognizer.STOP"
