...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "io.callix_tamilvanan.blackpulse.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "io.callix_tamilvanan.blackpulse.widget.LIKE"
        const val ACTION_NEXT = "io.callix_tamilvanan.blackpulse.widget.NEXT"
        const val ACTION_PREVIOUS = "io.callix_tamilvanan.blackpulse.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "io.callix_tamilvanan.blackpulse.widget.UPDATE_WIDGET"
    }
}
