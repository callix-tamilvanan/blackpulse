...
class TurntableWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TURNTABLE_PLAY_PAUSE = "io.callix_tamilvanan.blackpulse.widget.TURNTABLE_PLAY_PAUSE"
        const val ACTION_TURNTABLE_NEXT = "io.callix_tamilvanan.blackpulse.widget.TURNTABLE_NEXT"
        const val ACTION_TURNTABLE_PREVIOUS = "io.callix_tamilvanan.blackpulse.widget.TURNTABLE_PREVIOUS"
        const val ACTION_UPDATE_TURNTABLE_WIDGET = "io.callix_tamilvanan.blackpulse.widget.UPDATE_TURNTABLE_WIDGET"
    }
}
