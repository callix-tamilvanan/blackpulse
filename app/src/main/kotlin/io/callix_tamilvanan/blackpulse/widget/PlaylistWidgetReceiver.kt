...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "io.callix_tamilvanan.blackpulse.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "io.callix_tamilvanan.blackpulse.widget.playlists.UPDATE_WIDGET"
