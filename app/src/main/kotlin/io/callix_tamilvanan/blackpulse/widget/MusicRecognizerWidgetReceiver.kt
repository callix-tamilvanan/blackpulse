...
package io.callix_tamilvanan.blackpulse.widget
...
import io.callix_tamilvanan.blackpulse.recognition.MusicRecognitionService
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.ALBUM_ART_CACHE_FILE
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.PREF_ARTIST_NAME
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.PREF_COVER_ART_PATH
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.PREF_ERROR_MESSAGE
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.PREF_PULSE_FRAME
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.PREF_SONG_TITLE
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.PREF_STATE
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.PREFS_NAME
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.STATE_ERROR
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.STATE_IDLE
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.STATE_LISTENING
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.STATE_NO_MATCH
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.STATE_PROCESSING
import io.callix_tamilvanan.blackpulse.recognition.RecognitionForegroundService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "io.callix_tamilvanan.blackpulse.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "io.callix_tamilvanan.blackpulse.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "io.callix_tamilvanan.blackpulse.widget.recognizer.RESET"
    }
}
